...
void Cube::init_texture(ID3D11Device *pD3D11Device)
{
	...
	HRESULT hr;
	hr = CreateDDSTextureFromFile(pD3D11Device, L"../../media/textures/seafloor.dds", nullptr, &m_pTextureSRV);
	...
	hr = pD3D11Device->CreateSamplerState(&samplerDesc, &m_pSamplerLinear);
