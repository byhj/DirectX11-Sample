...
void RenderSystem::Render(ID3D11DeviceContext *pD3D11DeviceContext, d3d::MatrixBuffer m_Matrix, float time, float waveiness)
{
	m_Model.Render(pD3D11DeviceContext, m_Matrix, time, waveiness);
